...
List<Widget> widgets = [
  SpinKitThreeBounce(color: DeviceUtil.strToColor('ThreeBounce'), size: 30.0),
  SpinKitCircle(color: DeviceUtil.strToColor('Circle')),
  SpinKitChasingDots(color: DeviceUtil.strToColor('ChasingDots')),
  SpinKitRotatingCircle(color: DeviceUtil.strToColor('RotatingCircle')),
  SpinKitRotatingPlain(color: DeviceUtil.strToColor('RotatingPlain')),
  SpinKitPumpingHeart(color: DeviceUtil.strToColor('PumpingHeart')),
  SpinKitPulse(color: DeviceUtil.strToColor('Pulse')),
