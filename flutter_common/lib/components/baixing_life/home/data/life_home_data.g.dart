...
Recommend _$RecommendFromJson(Map<String, dynamic> json) {
  return Recommend(json['image'] as String, json['mallPrice'],
      json['goodsName'] as String, json['goodsId'] as String, json['price']);
}
...
Floor1 _$Floor1FromJson(Map<String, dynamic> json) {
  return Floor1(json['image'] as String, json['goodsId'] as String);
}

Map<String, dynamic> _$Floor1ToJson(Floor1 instance) =>
    <String, dynamic>{'image': instance.image, 'goodsId': instance.goodsId};

Floor2 _$Floor2FromJson(Map<String, dynamic> json) {
  return Floor2(json['image'] as String, json['goodsId'] as String);
}

Map<String, dynamic> _$Floor2ToJson(Floor2 instance) =>
    <String, dynamic>{'image': instance.image, 'goodsId': instance.goodsId};

Floor3 _$Floor3FromJson(Map<String, dynamic> json) {
  return Floor3(json['image'] as String, json['goodsId'] as String);
}

Map<String, dynamic> _$Floor3ToJson(Floor3 instance) =>
    <String, dynamic>{'image': instance.image, 'goodsId': instance.goodsId};
